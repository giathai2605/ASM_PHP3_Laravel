...
<form class="d-block row mx-3 mt-2 " method="POST" action="{{route('propertyCategory.add')}}" enctype="multipart/form-data" >
    @csrf
    <div class="row">
      ...
      <div class="col-md-6 mt-1">
          ...
          <input type="text" name="name" class="form-control" id="inputFullname" value="{{old('name')}}" placeholder="Chung cư ....">
          @error('name')
