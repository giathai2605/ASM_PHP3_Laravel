...
@section('content')
    <div class="table-responsive mt-5 mx-3">
        <div class="d-flex justify-content-between mt-2">
            ...
            <div>
                <form action="{{route('propertyCategory.list')}}" method="post">
                    @csrf
            ...
            <div>
                <a class="btn btn-primary" href="{{ route('propertyCategory.listTrashed') }}">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-center" scope="col"><a href="{{ route('propertyCategory.add') }}"
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="action-btns">
                                <a href="{{ route('propertyCategory.edit', ['id' => $item->id]) }}"
                                ...
                                <a href="{{ route('propertyCategory.delete', ['id' => $item->id]) }}"
