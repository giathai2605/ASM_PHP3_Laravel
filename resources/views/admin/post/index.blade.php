...
@section('content')
    <div class="table-responsive mt-5 mx-3">
        <div class="d-flex justify-content-between mt-2">
            <div>
                <a href="{{ route('post.list') }}">
                    <h2 class="mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        </svg><span class="mx-1">List Post</span></h2>
                </a>
            </div>
            <div>
            ...
            <div>
                <a class="btn btn-primary" href="{{ route('post.listTrashed') }}">
                    ...
                    <span class="mx-1 fs-6 ">Bài viết đã xóa</span>
                </a>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-center" scope="col">Comment_count</th>
                    <th class="text-center" scope="col">Status</th>
                    <th class="text-center" scope="col"><a href="{{ route('post.add') }}"
