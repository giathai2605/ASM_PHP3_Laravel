...
<form class="d-block row mx-3 mt-2 " method="POST" action="{{route('post.add')}}" enctype="multipart/form-data" >
    @csrf
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-8 mt-1">
            ...
            <input type="text" name="title" class="form-control" id="inputFullname" value="{{old('title')}}" placeholder="Tin tức ....">
            @error('title')
