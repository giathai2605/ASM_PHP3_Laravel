...
@section('content')
    <div class="table-responsive mt-5 mx-3">
        <div class="d-flex justify-content-between mt-2">
            <div>
                <a href="{{ route('postCategory.list') }}">
            ...
            <div>
                <form action="{{route('postCategory.list')}}" method="post">
                    @csrf
            ...
            <div>
                <a class="btn btn-primary" href="{{ route('postCategory.listTrashed') }}">
                    ...
                    <span class="mx-1 fs-6 ">Danh mục đã xóa</span>
                </a>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-center" scope="col"><a href="{{ route('postCategory.add') }}"
            ...
            <tbody>
                ...
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td class="text-center"><img src="{{ $item->image ? Storage::url($item->image) : 'https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}"
                                width="80" height="80" alt=""></td>
                                <td class="text-center">{{ $item->description ? $item->description : "Chưa có mô tả..."}}</td>

                        <td class="text-center">
                            <div class="action-btns">
                                <a href="{{ route('postCategory.edit', ['id' => $item->id]) }}"
                                ...
                                <a href="{{ route('postCategory.delete', ['id' => $item->id]) }}"
