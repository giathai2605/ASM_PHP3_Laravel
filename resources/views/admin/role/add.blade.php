...
<form class="d-block row mx-3 mt-2 " method="POST" action="{{route('role.add')}}" enctype="multipart/form-data" >
    @csrf
    <div class="row">
    ...
    <div class="col-md-6 mt-1">
      ...
      <div class="col-md-6 mt-1">
          ...
          <input type="text" name="role_name" class="form-control"  value="{{old('role_name')}}" placeholder="Tên vai trò ....">
          @error('role_name')
