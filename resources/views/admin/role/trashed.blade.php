...
@section('content')
    <div class="table-responsive mt-5 mx-3">
        <div class="d-flex justify-content-between mt-2">
            ...
            <div>
                <a class="btn btn-primary" href="{{ route('role.list') }}">
                    ...
                    <span class="mx-1 fs-6 ">Danh sách vai trò</span>
                </a>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="action-btns">
                                <a href="{{ route('role.restore', ['id' => $item->id]) }}"
                                ...
                                <a href="{{ route('role.forceDelete', ['id' => $item->id]) }}"
